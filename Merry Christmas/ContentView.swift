...
struct ContentView: View {
    ...
    var body: some View {
        VStack(spacing: 20){
            rectangleForFireworks
            textAnimation
            christmasTree
        }
    }
    
    // MARK: - Rectangle for Fireworks
    var rectangleForFireworks: some View {
        Rectangle()
    ...
    // MARK: - Christmas Tree animation
    var christmasTree: some View {
        VStack {
